...
class Loader extends Singleton {
	...
	public function admin_notices() {
		...
		if ( defined( 'PP_PRO_VERSION' ) && version_compare( PP_PRO_VERSION, '5.6.8', '<' ) ) {
			?>
			<div class="notice-warning notice is-dismissible pp-welcome-notice">
				<p><?php esc_html_e( 'There is an update available to Podcast Player Pro. Please update to Podcast Player Pro v5.6.8. If you have not received an automated update notice, please login to our website and download latest version.', 'podcast-player' ); ?></p>
			</div>
			<?php
		}
	}
