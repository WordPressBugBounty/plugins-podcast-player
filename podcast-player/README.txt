...
==Changelog ==
= 8.2.1 =
* Bug Fix: JS loading issue and Ajax timeout issues for captions.

= 8.2.0 =
* Modify: Code Refactoring and Improvements.
* Modify: Shortcode add current post ID.

= 8.1.0 =
* Modify: Pro compatibility improvements
* Modify: Admin page improvements

= 8.0.4 =
* Modify: Player website URL change and admin page changes.

= 8.0.3 =
* Bug Fix: Image download background jobs fix.

= 8.0.2 =
* Modify: Code cleanup and improvements
...
= 7.9.6 =
* Bug Fix: Seasons and Category dropdown filter.
* Bug Fix: Issues resolved in filter items by custom data.
...
* Modify: Improvements in the podcast player pro import options.

= 7.7.1 =
* Modify: In Grid view, fetched search results should not appear in the next line.
* Modify: Extend podcast pro analytics support for imported episodes.
* Modify: In default style, moved subscription buttons to bottom on smaller screen.
* Add: In default and modern layouts, option to show all initially loaded episodes without scrolling.

= 7.7.0 =
Modify: Support for better episode sharing on pro version.
...
= 7.4.7 =
* Bug Fix: Plugin textdomain loading early.
